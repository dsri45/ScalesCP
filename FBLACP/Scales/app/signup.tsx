        ...
        <SafeAreaView style={{ flex: 1, justifyContent: 'center' }}>
            <View style={{ paddingHorizontal: 25 }}>
                <View style={{ alignItems: 'center' }}>
                    <SignUpSVG height={300} width={300} style={{ transform: [{ rotate: '-5deg' }] }} />
                </View>
                ...
                <TouchableOpacity onPress={handleSignup} style={{ backgroundColor: '#AD40AF', padding: 20, borderRadius: 10, marginBottom: 30 }}>
